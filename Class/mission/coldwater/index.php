<!DOCTYPE html>
<!-- This is my coldwater page -->
<html> 
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>YOLO|Cold Water</title>
    ...
    <body>
        ...
        <br>
        <h2>
        My compa starting a feud with Elder Blanchard.
        </h2>
        <div style="text-align:center; margin-bottom:-25px">
        <iframe width="420" height="315" src="http://www.youtube.com/embed/Qzqzw0krlgM"></iframe>
        </div><br>
