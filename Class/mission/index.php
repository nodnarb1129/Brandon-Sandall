<!DOCTYPE html>
<!-- This is my mission page -->
<html> 
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>YOLO|Mission</title>
    ...
    <body>
        ...
        <br>
        <h2>
        Hover over Mission to show the drop down menu.
        </h2>
        <div style="text-align:center; margin-bottom:-25px">
        <img height="250" width="250" src="../images/mission.jpeg" alt="Mission">
        </div><br>
