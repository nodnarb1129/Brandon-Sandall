...
<html> 
    ...
    <body>
        ...
        <br>
        <h2>
        A video my buddy put together of our Arch Swing vacation.
        </h2>
        <div style="text-align:center; margin-bottom:-25px">
        <iframe width="560" height="315" src="http://www.youtube.com/embed/xaPKWhV5ZxE"></iframe>
        </div><br>
