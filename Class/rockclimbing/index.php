<!DOCTYPE html>
<!-- This is my Rock Climbing page -->
<html> 
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>YOLO|Rock Climbing</title>
    ...
    <body>
        ...
        <br>
        <h2>
        Hover over Rock Climbing to show the drop down menu.
        </h2>
        <div style="text-align:center; margin-bottom:-25px">
        <img src="../images/rockclimbing.jpeg" alt="Rock Climbing">
        </div><br>
