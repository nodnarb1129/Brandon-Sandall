<!DOCTYPE html>
<!-- This is my oldspice page -->
<html> 
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>YOLO|Old Spice</title>
    ...
    <body>
        ...
        <br>
        <h2>
        A video I made for the University Store, Old Spice style.
        </h2>
        <div style="text-align:center; margin-bottom:-25px">
        <iframe width="560" height="315" src="http://www.youtube.com/embed/Zs_xlSp6Cxc"></iframe>
        </div><br>
